...
<head>
    ...
    <!-- Vendor CSS -->
    <link href="<?php echo e(asset('frontend/js/vendor/bootstrap/bootstrap.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('frontend/js/vendor/slick/slick.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('frontend/js/vendor/fancybox/jquery.fancybox.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('frontend/js/vendor/animate/animate.min.css')); ?>" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="<?php echo e(asset('frontend/css/style-light.css')); ?>" rel="stylesheet">
    <!--icon font-->
    <link href="<?php echo e(asset('frontend/fonts/icomoon/icomoon.css')); ?>" rel="stylesheet">
    <!--custom font-->
...
<body class="home-page is-dropdn-click has-slider">
    ...
    <header class="hdr global_width hdr_sticky hdr-mobile-style2">
                ...
                <div class="mobilemenu-scroll">
                    ...
                    <div class="nav-wrapper show-menu">
                        ...
                        <ul class="nav nav-level-1">
                            ...
                            <li><a href="<?php echo e(url('/contact_us')); ?>" >Contact US<span class="menu-label menu-label--color3">Hurry Up!</span></a><span class="arrow"></span></li>
                        </ul>
                    </div>
        ...
        <div class="hdr-desktop hide-mobile">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-auto hdr-topline-right links-holder">
                            ...
                            <div class="dropdn dropdn_wishlist @classes"><a href="<?php echo e(url('/my_wishlist')); ?>" class="dropdn-link "><i class="icon icon-heart-1" ></i>
                            ...
                            <div class="dropdn dropdn_account @classes"><a href="#" class="dropdn-link"><i class="icon icon-person"></i><span>My Account</span></a>
                                <div class="dropdn-content">
                                    <div class="container">
                                        ...
                                        <ul>
                                            <li><a href="<?php echo e(url('/account_detail')); ?>"><i class="icon icon-person-fill"></i><span>My Account</span></a></li>
                                          
                                          
                                            <?php if(session()->has('FRONT_USER_LOGIN')!=null): ?>
                                           <li><a href="<?php echo e(url('/logout')); ?>"><i class="icon icon-lock"></i><span>Log Out</span></a></li>

                                           <?php else: ?>

                                           <li><a href="<?php echo e(url('login_user')); ?>"><i class="icon icon-lock"></i><span>Log In</span></a></li>

                                           <?php endif; ?>
                                          
                                            <li><a href="<?php echo e(url('regestration')); ?>"><i class="icon icon-person-fill-add"></i><span>Register</span></a></li>
                                            <li><a href="<?php echo e(url('/checkout')); ?>"><i class="icon icon-check-box"></i><span>Checkout</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="hdr-content hide-mobile">
                <div class="container">
                    <div class="row">
                        <div class="col-auto logo-holder"><a href="<?php echo e(url('/')); ?>" class="logo"><img src="<?php echo e(asset('frontend/images/logo.png')); ?>" srcset="images/logo-retina.png 2x" alt=""></a></div>
                        <!--navigation-->
                                                ...
                                                <div class="container">
                                                    <div class="mmenu-right width-20">
                                                        ...
                                                        <div class="prd-carousel-menu" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "arrows": true}'>
                                                            <div class="prd-sm"><a href="product.html" class="prd-img"><img src="<?php echo e(asset('frontend/images/products/product-placeholder.png')); ?>" data-srcset="images/products/product-11-2.jpg" class="lazyload" alt=""></a>
                                                                <div class="prd-info">
                                                            ...
                                                            <div class="prd-sm"><a href="product.html" class="prd-img"><img src="<?php echo e(asset('frontend/images/products/product-placeholder.png')); ?>" data-srcset="images/products/product-06-2.jpg" class="lazyload" alt=""></a>
                                                                <div class="prd-info">
                                                    ...
                                                    <div class="mmenu-cols column-5">
                                                        ...
                                                        <div class="mmenu-col">
                                                            ...
                                                            <div class="submenu-img"><a href="category.html"><img src="<?php echo e(asset('frontend/images/placeholder.png')); ?>" data-src="images/menu/category-img-05.jpg" class="lazyload" alt=""></a></div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-auto minicart-holder">
                            <div class="minicart minicart-js "><a href="javascript:void(0)" class="minicart-link"><i class="icon icon-handbag"></i> <span class="minicart-qty"><?php echo e($totalCardItem); ?></span> <span class="minicart-title">Shopping Cart</span>
                                ...
                                <div class="minicart-drop"   >
                                    <div class="container" >
                                        ...
                                        <?php if( $totalCardItem>0): ?>
                                            <h3>Recently added items:</h3>
                                            <?php $__currentLoopData = $getAddtoCardTotalItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Carditem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <div class="minicart-prd" >
                                                <div class="minicart-prd-image"><a href="#"><img src="<?php echo e(asset('storage/media/'.$Carditem->image)); ?>" data-srcset="<?php echo e(asset('storage/media/'.$Carditem->image)); ?>" class="lazyload" alt="<?php echo e($Carditem->name); ?>"></a></div>
                                                <div class="minicart-prd-name">
                                                    <h2><a href="#"><?php echo e($Carditem->name); ?></a></h2>
                                                    <?php if($Carditem->color!=''): ?>
                                                    <h5>color: <?php echo e($Carditem->color); ?></h5>
                                                    <?php endif; ?>
                                                    <?php if($Carditem->size!=''): ?>
                                                    <h5>size: <?php echo e($Carditem->size); ?></h5>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="minicart-prd-qty"><span>qty:</span> <b><?php echo e($Carditem->qty); ?></b></div>
                                                <div class="minicart-prd-price"><span>price:</span> <b>$ <?php echo e($Carditem->price*$Carditem->qty); ?></b></div>
                                                <!--  -->
                                            </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                           
                                            <div class="minicart-drop-total">
                                                <div class="float-right"><span class="minicart-drop-summa"><span>Cart Subtotal:</span> <b id="total_shopping_cart">$ <?php echo e($sum); ?></b></span>
                                                    <div class="minicart-drop-btns-wrap"><a href="<?php echo e(url('/checkout')); ?>" class="btn"><i class="icon-check-box"></i><span>checkout</span></a> <a href="cart.html" class="btn btn--alt"><i class="icon-handbag"></i><span>view cart</span></a></div>
                                                </div>
                                                <div class="float-left"><a href="<?php echo e(url('/view_card')); ?>" class="btn btn--alt"><i class="icon-handbag"></i><span>view cart</span></a></div>
                                            </div>
                                        </div>
                                        <?php endif; ?>
        ...
        <div class="sticky-holder compensate-for-scrollbar" >
            <div class="container">
                <div class="row"><a href="#" class="mobilemenu-toggle show-mobile"><i class="icon icon-menu"></i></a>
                    <div class="col-auto logo-holder-s"><a href="index.html" class="logo"><img src="<?php echo e(asset('frontend/images/logo.png')); ?>" srcset="images/logo-retina.png 2x" alt=""></a></div>
                    <!--navigation-->
                    <div class="prev-menu-scroll icon-angle-left prev-menu-js"></div>
   ...
   <?php echo $__env->yieldSection(); ?>
    ...
    <footer class="page-footer footer-style-1 global_width">
            ...
            <div class="row py-md-4">
                    ...
                    <div class="footer-block collapsed-mobile">
                        ...
                        <div class="collapsed-content">
                            <ul>
                                ...
                                <li><a href="<?php echo e(url('/contact_us')); ?>">Contact Info</a></li>
                                <li><a href="<?php echo e(url('/regestration')); ?>">Create Account</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg">
                    <div class="footer-block collapsed-mobile">
                        ...
                        <div class="collapsed-content">
                            <ul>
                                <li><a href="<?php echo e(url('/account_detail')); ?>">My Account</a></li>
                                <li><a href="<?php echo e(url('/view_card')); ?>">View Cart</a></li>
                                <li><a href="<?php echo e(url('/my_wishlist')); ?>">My Wishlist</a></li>
                                <li><a href="<?php echo e(url('/order_history')); ?>">Order Status</a></li>
                                <li><a href="<?php echo e(url('/order_history')); ?>">Track My Order</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom container">
            <div class="row lined py-2 py-md-3">
                <div class="col-md-2 hidden-mobile"><a href="#"><img src="<?php echo e(asset('frontend/images/logo-footer-dark.png')); ?>" class="img-fluid" alt=""></a></div>
                ...
                <div class="prd-block" id="prdGalleryModal">
                    ...
                    <div class="product-previews-wrapper">
                        <div class="product-quickview-carousel slick-arrows-aside-simple js-product-quickview-carousel">
                            <div><a href="images/products/large/product-01.jpg" data-fancybox="gallery"><img src="<?php echo e(asset('frontend/images/products/product-01.jpg')); ?>" alt=""></a></div>
                            <div><a href="images/products/large/product-01-2.jpg" data-fancybox="gallery"><img src="<?php echo e(asset('frontend/images/products/product-01-2.jpg')); ?>" alt=""></a></div>
                            <div><a href="images/products/large/product-01-3.jpg" data-fancybox="gallery"><img src="<?php echo e(asset('frontend/images/products/product-01-3.jpg')); ?>" alt=""></a></div>
                            <div><a href="images/products/large/product-01-4.jpg" data-fancybox="gallery"><img src="<?php echo e(asset('frontend/images/products/product-01-4.jpg')); ?>" alt=""></a></div>
                            <div><a href="images/products/large/product-01-5.jpg" data-fancybox="gallery"><img src="<?php echo e(asset('frontend/images/products/product-01-5.jpg')); ?>" alt=""></a></div>
                        </div>
    ...
    <!--</div>-->
    <!--</div>-->
    <script src="<?php echo e(asset('frontend/js/vendor/jquery/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/bootstrap/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/slick/slick.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/scrollLock/jquery-scrollLock.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/instafeed/instafeed.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/countdown/jquery.countdown.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/imagesloaded/imagesloaded.pkgd.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/ez-plus/jquery.ez-plus.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/tocca/tocca.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/bootstrap-tabcollapse/bootstrap-tabcollapse.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/isotope/jquery.isotope.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/fancybox/jquery.fancybox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/cookie/jquery.cookie.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/bootstrap-select/bootstrap-select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/lazysizes/lazysizes.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/lazysizes/ls.bgset.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/form/jquery.form.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/form/validator.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/vendor/slider/slider.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/app.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/main.js')); ?>"></script>
   
   <script> 
    var PRODUCT_IMG=src="<?php echo e(asset('storage/media/')); ?>";
    var viewcard_link="<?php echo e(url('/view_card')); ?>";
    </script>
</body>

</html><?php /**PATH C:\laragon\www\ecommerce\resources\views/front/layouts.blade.php ENDPATH**/ ?>