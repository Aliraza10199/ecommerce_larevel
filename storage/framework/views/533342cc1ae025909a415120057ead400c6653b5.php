                    ...
                    <?php $__currentLoopData = $home_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="prd prd-has-loader prd-new prd-popular">
                                <div class="prd-inside">
                                    <div class="prd-img-area"><a href="<?php echo e(url('product/')); ?>/<?php echo e($list->slug); ?>" class="prd-img"><img src="<?php echo e(asset('storage/media/'.$list->image)); ?>" class="prd-img"><img src="<?php echo e(asset('storage/media/'.$list->image)); ?>" data-srcset="<?php echo e(asset('storage/media/'.$list->image)); ?>" alt="<?php echo e($list->name); ?>" class="js-prd-img lazyload"></a>
...
<?php echo $__env->make('front/layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ecommerce\resources\views/front/All_products.blade.php ENDPATH**/ ?>