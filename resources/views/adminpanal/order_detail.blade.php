...
@section('page_title','Admin Order Detail')
...
<div class="mb-5  bg-light">
    <h1 class="text-center mb-5 mt-3 "> Order Detail:- {{$orders_details[0]->id}}</h1>
                                    ...
                                    <div class="table-responsive m-b-40">
                                        <table class="table table-borderless table-data3 " >
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="bg-success fs-5 fw-bold"> {{$num}} </td>
                                                    <td>  {{$list->pname}} </td>
                                                    <td class=""><a href=""><img  src="{{asset('storage/media/'.$list->image_attr)}}" alt=""></a> </td>
    ...
    <div class="order_operation bg-light p-4 ">
        ...
        <select id="payment_status" onchange="update_payment_status({{$orders_details[0]->id}})"  class="form-control" >
         @php
        ...
        <b>Track Details</b>
        <form method="post">
           <textarea name="track_detail" class="form-control  m-b-10" required>{{$orders_details[0]->track_detail}}</textarea>
